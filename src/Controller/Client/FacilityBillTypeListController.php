...
use App\Model\Table\FacilityBillTypeTable; // Make sure to adjust the namespace

class FacilityBillTypeListController extends AppController
{
    ...
    {
        parent::initialize();
        $this->Agency = new FacilityBillTypeTable();
    }
