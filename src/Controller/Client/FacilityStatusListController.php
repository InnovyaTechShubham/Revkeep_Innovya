...
use App\Model\Table\FacilityStatusTable; // Make sure to adjust the namespace

class  FacilityStatusListController extends AppController
{
    ...
    {
        parent::initialize();
        $this->Agency = new FacilityStatusTable();
    }
